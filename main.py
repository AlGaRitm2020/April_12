        ...
        for i, bullet in enumerate(self.bullets):
            ...
            if bullet.direction == -1:
                for j, enemy in enumerate(self.enemies):
                    if abs(enemy.get_position()[0]-bullet.get_position()[0]) < 29 and abs(
                            enemy.get_position()[1]-bullet.get_position()[1]) < 29:
            ...
            # вражеские пули
                ...
                if abs(self.hero.get_position()[0]-bullet.get_position()[0]) < 29 and abs(
                        self.hero.get_position()[1]-bullet.get_position()[1]) < 29:
                    # cнятие здоровья у героя и уничтожение пули
                    self.hero.health -= random.randint(0, 30)
